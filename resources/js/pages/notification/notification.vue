  ...
  <div v-if="isLoadig">
    ...
    >
      ...
      <section class="ps-container scroll dashboard-list-with-user ps">
        ...
        >
          <div
            v-if="item.created_at != $route.params.notificationId"
          ...
          >
            ...
            <p class="text-muted mb-0 text-small" style="margin-left: 10px">
              {{ item.body }}
            </p>
            <span
              class="text-muted mb-0 text-small badge-light badge-pill"
          ...
          <div
            v-if="item.created_at == $route.params.notificationId"
            style="background-color: #eeeeee; padding: 15px 20px 15px 20px"
          >
            <div style="display: flex">
              <p class="font-weight-medium mb-0">{{ item.title }}</p>
