                ...
                <div class="table-responsive vue-smart">
                  ...
                  >
                    ...
                    <template #cell(Membership_private_Features)="data">
                      <i
                        v-if="data.item.Membership_private_Features"
                      ...
                      <div>
                        <b-button-group class="btn-container">
                          ...
                          >
                            <router-link
                              ...
                              :to="{
                                ...
                                params: { membershipId: data.item.id },
                              }"
                              v-if="can('edit-membership')"
                            >
                              {{ $t("edit") }}
                          ...
                          <b-button
                            ...
                            class="btn-sm btn-child"
                            @click="
                              DeleteMembershipModal(data.item.id, data.index)
                            "
