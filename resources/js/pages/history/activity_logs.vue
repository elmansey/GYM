<template>
  <div v-if="isLoadig">
    <Breadcrumbs :main="$t('Dashboard')" :title="$t('Activities logs')" />
      ...
      <div style="display: flex; max-width: 600px; padding: 20px; margin: auto;background-color: #fff;" class="mb-10">
    ...
    <div  style=" max-width: 600px;  margin: auto auto 100px auto!important; background-color: #fff; height: 822px;overflow: scroll; " class="card-body">
        ...
        <section  class="ps-container scroll dashboard-list-with-user ps" v-for="(item,index) in history" :key="index" style="direction: ltr !important;" >
            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                    <img :src="item.user_relation.profile_picture ? `../../profile_pictures/${item.user_relation.profile_picture }` : '../../profile_pictures/DefaultProfile.jpg'"
