            ...
            <div class="row chat-box">
              ...
              <div class="col pr-0 chat-right-aside">
                ...
                <div class="chat mb-0 pb-0">
                  ...
                  <div class="chat-header clearfix">
                    ...
                    <div class="about">
                      <div class="name" v-if="chatting">
                        ...
                        <p class="font-primary f-12" v-if="typeStatus">
                          {{ typeStatus }} ....
                        </p>
                      </div>
                    </div>
                      ...
                      <li>
                        <div class="message" style="width: 100%">
                          <div
                            ...
                            :key="index"
                            :class="[
                              message.from == $store.getters.USER.id
                                ? ' float-left block '
                                : ' float-right block ',
                            ]"
                            style="clear: both"
                          >
                            <div
                              class="card d-inline-block mb-3 float-right"
                              style="
                            ...
                            >
                              <div class="card-body">
                                ...
                                <div class="pt-1 pr-2 r-0 float-left">
                                  <span
                                    v-for="(time, index) in message.send_at"
                                    :key="index"
                                    class="text-extra-small text-muted m-3"
                  ...
                  <form
                    v-if="chatting"
                    @submit.prevent="handelSubmitFormMessage"
                    style="width: 80% !important; margin: auto !important"
                  >
                    <div
                      class="chat-message"
                      style="width: 80% !important; margin: auto !important"
                    >
                      <div
                        class="row"
                        style="width:100%!important;height: 100%;!important;padding: 0px;!important;margin:0px"
                      >
                        <div
                          class="col-xl-12 d-flex"
                          style="height: 100%!important;padding: 0px;!important;margin:0px"
                        >
                          <input
                            @keydown="typing"
                            class="input-txt-bx"
                          ...
                          <div>
                            <button
                              ...
                              type="submit"
                              style="border-radius: 50%; padding: 12px 14px"
                            >
              ...
              >
                ...
                >
                  <b-tab
                    :title="$t('team')"
                    active
                    style="margin: 5px !important; padding: 0px !important"
                  >
                    <div class="people-list" v-if="isloading">
                      <ul class="list digits">
                        ...
                        >
                          ...
                          />
                          <span
                            v-if="teamPerson.messageTeamRelationTo.length > 0"
                          ...
                          <div class="about">
                            <div
                              class="name"
                              @click.prevent="
                                getOldMessageInChat(teamPerson.id)
                              "
                            >
                              {{ teamPerson.name }}
                            </div>
                            <div
                              class="status"
                              style="display: flex;margin-top:0px;!important"
                            >
                              <i
...
export default {
  ...
  mounted() {
    Echo.private(`team_chat.${this.chatInfo.from}`).listen(
      "NewMessage",
      (e) => {
        if (
          e.message.to == this.$store.getters.USER.id &&
          this.chatting &&
          e.message.from == this.selected
        ) {
    ...
    Echo.private("typingEvent").listenForWhisper("typing", (e) => {
      if (
        e.resever == this.$store.getters.USER.id &&
        this.selected == e.sender
      ) {
  ...
  methods: {
    readMessage() {
      ...
      axios
        .post("setReadingMessage", formData)
        .then((res) => {})
        .catch((err) => {});
    },
    ...
    getALLteamToChat() {
      axios
        .get(`getUserToChatIgnoreMe/${this.$store.getters.USER.email}`)
        .then((res) => {
    ...
    getOldMessageInChat(id) {
      ...
      axios
        .post("getOldMessageInChat", formData)
        .then((res) => {
    ...
    scrollChatToLastMessage() {
      setTimeout(() => {
        this.$refs.lastMessage.scrollTop =
          this.$refs.lastMessage.scrollHeight -
          this.$refs.lastMessage.clientHeight;
      }, 50);
    },
    ...
    handelSubmitFormMessage() {
      ...
      axios
        .post("addMessageInTeamChat", formData)
        .then((res) => {
          if (res.data.success) {
