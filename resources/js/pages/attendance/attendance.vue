          ...
          <div class="card">
            <div class="card-body">
              ...
              <b-modal id="bv-modal-selected" hide-footer>
                <template #modal-title> Delete selected attendance </template>
                <div class="d-block text-center">
                  <h5>are you sure to delete this selected attendance</h5>
                </div>
                <b-button
                  class="mt-3"
                  v-b-modal.modal-sm
...
export default {
  data() {
    return {
      tablefields: [
        ...
        {
          key: "come_dateTime",
          label: this.$t("come dateTime"),
          sortable: false,
        },
        {
          key: "leave_dateTime",
          label: this.$t("leave dateTime"),
          sortable: false,
        },
      ],
      totalRows: 1,
  ...
  watch: {
    selected: function (selected) {
      this.selectedAll =
        selected.length === Object.values(this.attendance).length;
