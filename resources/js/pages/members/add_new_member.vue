<template>
  <div v-if="isLoading">
    <Breadcrumbs
      :main="$t('Dashboard')"
      :title="edit ? $t('edit member') : $t('registeration a new member')"
    />
                ...
                <form @submit.prevent="handelSubmitData" id="myform">
                  <div class="row">
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <small style="color: red" v-if="error.gender">{{
                        $t(error.gender[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        name="phone"
                        @change="countMemberAge"
                        type="date"
                        :class="[
                          'form-control',
                          error.data_of_birth ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.data_of_birth"
                      />
                      <small style="color: red" v-if="error.date_of_birth">{{
                        $t(error.date_of_birth[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        ...
                        v-model="memberData.age"
                      />
                      <small style="color: red" v-if="error.age">{{
                        $t(error.age[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      />
                      <small style="color: red" v-if="error.address">{{
                        $t(error.address[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      />
                      <small style="color: red" v-if="error.city">{{
                        $t(error.city[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        name=""
                        type="date"
                        @change="setExpireDate"
                        :class="[
                          'form-control',
                          error.start_date ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.start_data"
                      />
                      <small style="color: red" v-if="error.start_date">{{
                        $t(error.start_date[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <select
                        name="membership"
                        @change="IsAllowFuatureInThisMembership"
                        :class="[
                          'form-control',
                          error.membership_id ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.membership_id"
                      >
                        <option
                          :value="item.id"
                      ...
                      <small style="color: red" v-if="error.membership_id">{{
                        $t(error.membership_id[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        ...
                        v-model="memberData.membership_price"
                      />
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          error.Subscription_period ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.Subscription_period"
                      />
                      <small
                        style="color: red"
                        v-if="error.Subscription_period"
                        >{{ $t(error.Subscription_period[0]) }}</small
                      >
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          error.period_Expiry ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.period_Expiry"
                      />
                      <small style="color: red" v-if="error.period_Expiry">
                        {{ $t(error.period_Expiry[0]) }}
                      </small>
                    </div>
                    ...
                    <div class="mb-2 col-md-6 col-lg-6 col-sm-12">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          error.total_payment ? 'is-invalid' : '',
                        ]"
                        v-model="memberData.total_payment"
                      />
                      <small style="color: red" v-if="error.total_payment">{{
                        $t(error.total_payment[0])
                      }}</small>
                    </div>

                    <div
                      class="mb-2 col-md-12 col-lg-12 col-sm-12"
                      v-if="memberData.Membership_choose_allow_private_Features"
                    >
                      <div class="col-form-label">{{ $t("groups") }}</div>

                      <multiselect
                        name="group"
                        @input="getAllClasseRelatedToThisGroup"
                        v-model="memberData.group_id"
                        tag-placeholder="Add this as new tag"
                        placeholder="Search or add a tag"
                        :class="[error.group_id ? 'is-invalid' : '']"
                        label="name"
                        track-by="id"
                        :options="groups"
                        :multiple="true"
                    ...
                    <div
                      class="mb-2 col-md-12 col-lg- col-sm-12"
                      v-if="
                        memberData.Membership_choose_allow_private_Features &&
                        afterChooseGroup
                      "
                    >
                      <div class="col-form-label">
                              ...
                              >
                                ...
                                <template #cell(days)="data">
                                  ...
                                  <span
                                    ...
                                    class="badge badge-pill badge-dark"
                                    v-for="(val, ke) in data.item.days"
                                    :key="ke"
                                  >
                                    {{ val.name }}
                                  </span>
                      ...
                      <small style="color: red" v-if="error.class_id">{{
                        $t(error.class_id[0])
                      }}</small>
                    </div>
                    ...
                    <div class="mb-2 col-md-12 col-lg-12 col-sm-12">
                      ...
                      <textarea
                        ...
                        v-model="memberData.interested_area"
                      ></textarea>
                      <small style="color: red" v-if="error.interested_area">{{
                        error.interested_area[0]
                      }}</small>
                    </div>
...
export default {
  ...
  beforeMount() {
    ...
    if (this.$route.params.memberId) {
      ...
      axios
        .get(`getMemberById/${this.$route.params.memberId}`)
        .then((res) => {
          if (res.data.success) {
            (this.memberData.name = res.data.extraInformation.name),
              ...
              (this.memberData.data_of_birth =
                res.data.extraInformation.date_of_birth),
              ...
              (this.memberData.interested_area =
                res.data.extraInformation.interested_area),
              ...
              (this.memberData.membership_id =
                res.data.extraInformation.membership_id),
              (this.memberData.class_id = res.data.extraInformation.class_id),
              (this.memberData.start_data =
                res.data.extraInformation.start_date);
            this.memberData.RF_code = res.data.extraInformation.RF_code;
            this.memberData.period_Expiry =
              res.data.extraInformation.period_Expiry;
            this.memberData.total_payment =
              res.data.extraInformation.total_payment;
            this.memberData.membership_price =
              res.data.extraInformation.membership_price;
            this.memberData.Subscription_period =
              res.data.extraInformation.Subscription_period;
            this.memberData.Membership_choose_allow_private_Features =
              this.IsAllowFuatureInThisMembership();
  ...
  methods: {
      ...
      this.memberships.map((item, index) => {
        if (item.id == this.memberData.membership_id) {
          ...
          if (
            ...
            this.memberData.Subscription_period == 0
          ) {
            this.memberData.Subscription_period = 1;
          } else {
            this.memberData.Subscription_period =
          ...
          var Expiry_date = new Date(
            start_date.setDate(
              start_date.getDate() +
                Number(Number(this.memberData.Subscription_period) * Period)
            )
          );
          this.memberData.period_Expiry =
          ...
          this.memberData.total_payment =
            Number(item.Membership_price) *
            Number(this.memberData.Subscription_period);
        }
      });
    },
    ...
    getAllClasseRelatedToThisGroup() {
      axios
        .post("getAllClasseRelatedToThisGroup", this.memberData.group_id)
        .then((res) => {
          this.classes = res.data.classes;
    ...
    IsAllowFuatureInThisMembership() {
      ...
      axios
        .get(`IsAllowFuatureInThisMembership/${this.memberData.membership_id}`)
        .then((res) => {
          if (res.data.success) {
            this.memberData.Membership_choose_allow_private_Features =
              res.data.allow;
    ...
    handelSubmitData() {
      if (this.edit == false) {
        ...
        formData.append(
          "Membership_choose_allow_private_Features",
          this.memberData.Membership_choose_allow_private_Features
        );
            ...
            if (res.data.success) {
              ...
              if (role != "owner") {
                ...
                var body =
                  ...
                  "    " +
                  "membership : " +
                  res.data.member.member_ships_relation.name +
                  "    " +
                  "payment : " +
                  res.data.member.payment +
                  "    " +
                  "total payment : " +
                  res.data.member.total_payment +
                  "    " +
                  "start date : " +
                  res.data.member.start_date +
                  "    " +
                  "period Expiry : " +
                  res.data.member.period_Expiry +
                  "    " +
                  "Subscription period : " +
                  res.data.member.Subscription_period +
                  "    ";
                ...
                this.saveNotificationInFireBaseDatabase(
                  title,
                  body,
                  DateTime,
                  created_at
      ...
      if (this.edit) {
        ...
        axios
          .post(`updateMember/${this.$route.params.memberId}`, formData, config)
          .then((res) => {
            if (res.data.success == false) {
              this.error = res.data.message;
            }
