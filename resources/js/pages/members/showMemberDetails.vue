          ...
          <div class="card">
              ...
              <img
                ...
                :src="
                  details.profile_picture
                    ? '../../profile_pictures/' + details.profile_picture
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="card-body">
                  <table class="table">
                    <tbody>
                      <tr>
                        <th width="50" style="font-size: 17px;font-weight">
                          {{ $t("uuid") }}
                        </th>
                        <td>
                      ...
                      <tr v-if="details.class_relation">
                        ...
                        <td>
                          {{
                            "from : " +
                            details.class_relation.startingTime +
                            "to: " +
                            details.class_relation.endingTime
                          }}
                        </td>
                      </tr>
                      <tr
                        v-if="details.group_id && details.group_id.length > 1"
                      >
                        <th width="50" style="font-size: 17px;font-weight">
                          {{ $t("group") }}
                        </th>
                        <td>
                          <span
                            ...
                            v-for="(val, ke) in details.group_id"
                            :key="ke"
                          >
                            {{ val.name }}
                          </span>
              ...
              <div style="overflow: scroll" class="col-lg-6 col-md-6">
                <div class="card-body">
                  <div><i class="fa fa-link m-15"></i>{{ $t("logs") }}</div>
...
export default {
  ...
  beforeMount() {
    if (this.$route.params.memberBaseId) {
      axios
        .get(`getMemberById/${this.$route.params.memberBaseId}`)
        .then((res) => {
          if (res.data.success) {
