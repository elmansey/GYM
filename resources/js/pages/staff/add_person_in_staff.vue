<template>
    <div v-if="isLoading">
        <Breadcrumbs
            main="dashboard"
            :title="edit ? 'edit person in  staff' : 'add person in staff'"
        />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form
                                    @submit.prevent="handelStaffFormSubmit"
                                    id="myform"
                                >
                                    <div class="row">
                                        <div
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                v-model="StaffData.middleName"
                                            />
                                            <small
                                                style="color: red"
                                                v-if="error.middleName"
                                                >{{
                                                    error.middleName[0]
                                                }}</small
                                            >
...
export default {
    ...
    beforeMount() {
        if (this.$route.params.staffId) {
            ...
            axios
                .get(`getItemFromStaffById/${this.$route.params.staffId}`)
                .then(res => {
    ...
    methods: {
        ...
        handelStaffFormSubmit() {
            ...
            if (this.edit) {
                ...
                axios
                    .post(
                        `updateInStaff/${this.$route.params.staffId}`,
                        formData,
                        config
                    )
                    .then(res => {
