    ...
    // required auth
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: require("@/pages/members/freezeMemberAccountList")
                    .default,
                meta: {
...

            {
                path: "tackAttendance",
                name: "tackAttendance",
                component: require("@/pages/attendance/take_attendance")
                    .default,
                meta: {
            ...
            },
            {
                path: "classSchedule",
                name: "classSchedule",
                component: require("@/pages/classSchedule/classSchedule")
                    .default,
                meta: {
            ...
            },
            {
                ...
                component: require("@/pages/classSchedule/classScheduleAddEDIT")
                    .default,
                meta: {
